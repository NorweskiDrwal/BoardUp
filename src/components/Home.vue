  ...
  <!-- meetups buttons -->
    <v-layout row wrap class="mb-2">
      <v-flex xs12 sm6 class="text-sm-right text-xs-center">
        <v-btn large to='/meetups' class="purple lighten-3">Explore Meetups</v-btn>
      </v-flex>
      <v-flex xs12 sm6 class="text-sm-left text-xs-center">
        <v-btn large to='/meetup/new' class="purple lighten-3">Organize Meetup</v-btn>
      </v-flex>
    </v-layout>
  <!-- end meetup buttons -->
  ...
  <!-- loader -->
    <v-layout row>
      <v-flex xs12 class="text-xs-center">
        <v-progress-circular indeterminate color="primary--text" :width="7" :size="70" v-if="loading"></v-progress-circular>
      </v-flex>
    </v-layout>
  <!-- end loader -->
